const makeNeptuniaPOI = [
    ...
    {id: 10, designation: "Name: Produce Aisle - Complete", title: "Location: Outer Khan", description: "The hidden island guarded by Mortos, Defiler of Nations. At its center is rumored to be the last Khan Unicorn and will bestow great gifts if approached in a friendly fashion. Good luck fighting past the guardians it conjures."},
